...
function attempt(task:flighthq._internal._Promise<Float>, log:Array<Float>):flighthq._internal._Promise<Float> {
  return new flighthq._internal._Promise(function(resolveTask, rejectTask) {
    try {
      var taskJoin = function() {
        try {
          resolveTask(cast(null));
          return;
