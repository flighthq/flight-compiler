...
abstract _Float32Array(Array<Float>) {
  ...
  public inline function subarray(begin:Float = 0, end:Float = 0):_Float32Array { return new _Float32Array(); }
  public inline function slice(begin:Float = 0, end:Float = 0):_Float32Array { return new _Float32Array(); }
}
