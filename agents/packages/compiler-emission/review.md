...
- **Order independence.** Preferred spellings are reserved before suffixing, so input order cannot choose which declaration wins — the property that makes the allocation reproducible across runs.
