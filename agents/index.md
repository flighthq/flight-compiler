...
- [flight-cpp coverage plan](flight-cpp-coverage-plan.md): the staged order of attack from the current SDK emit share to zero refusals, with the corpus evidence each stage is ranked by.
