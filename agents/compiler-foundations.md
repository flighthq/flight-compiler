...
2. `compiler-canonical-form` defines machine-independent text order and portable path form without owning domain identity policy.
...
2. Define machine-independent portable path separator form, migrate all ten production implementations across five packages, and preserve domain-owned Unicode, validation, and path-resolution policy.
