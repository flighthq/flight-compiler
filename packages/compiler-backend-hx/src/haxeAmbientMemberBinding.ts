...
const haxeAmbientMemberBindings: Readonly<Record<string, CompilerHaxeAmbientMemberBinding>> = {
  ...
  'array.copyWithin': { intArguments: [0, 1, 2], kind: 'runtimeCall', targetName: '_Array.copyWithin' },
  'array.entries': { kind: 'runtimeCall', targetName: '_Array.entries' },
  'array.every': { kind: 'staticCall', targetPath: 'Lambda.foreach' },
  'array.fill': { intArguments: [1, 2], kind: 'runtimeCall', targetName: '_Array.fill' },
  'array.filter': { kind: 'method', targetName: 'filter' },
  'array.flat': { intArguments: [0], kind: 'runtimeCall', targetName: '_Array.flat' },
  ...
  // RegExpExecArray extends Array in the source ambient surface, so its metadata fields retain the
  // array receiver identity even though ordinary arrays cannot expose them.
  'array.index': { kind: 'property', targetName: 'index' },
  ...
  'error.cause': { kind: 'property', targetName: 'cause' },
  'error.message': { kind: 'property', targetName: 'message' },
  'error.name': { kind: 'property', targetName: 'name' },
  'error.stack': { kind: 'property', targetName: 'stack' },
  'number.toFixed': { intArguments: [0], kind: 'runtimeCall', targetName: '_Number.toFixed' },
  'number.toString': { intArguments: [0], kind: 'runtimeCall', targetName: '_Number.toString' },
  ...
  'string.codePointAt': { intArguments: [0], kind: 'runtimeCall', targetName: '_StringTools.codePointAt' },
  ...
  'string.padStart': { intArguments: [0], kind: 'runtimeCall', targetName: '_StringTools.padStart' },
  'string.padEnd': { intArguments: [0], kind: 'runtimeCall', targetName: '_StringTools.padEnd' },
  ...
  'string.repeat': { intArguments: [0], kind: 'runtimeCall', targetName: '_StringTools.repeat' },
  'string.search': { kind: 'runtimeCall', targetName: '_StringTools.search' },
  'string.slice': { intArguments: [0, 1], kind: 'runtimeCall', targetName: '_StringTools.slice' },
  'string.split': { intArguments: [1], kind: 'runtimeCall', targetName: '_StringTools.split' },
  ...
  'typedArray.copyWithin': { intArguments: [0, 1, 2], kind: 'runtimeCall', targetName: '_TypedArray.copyWithin' },
  ...
  'typedArray.slice': { intArguments: [0, 1], kind: 'method', targetName: 'slice' },
  'typedArray.subarray': { intArguments: [0, 1], kind: 'method', targetName: 'subarray' },
