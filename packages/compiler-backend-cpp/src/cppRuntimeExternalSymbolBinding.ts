...
const cppFlightRuntimeExternalSymbolBindings = [
  ...
  },
  {
    ...
    members: [
      ...
      { sourceMember: 'NaN', targetName: 'std::numeric_limits<double>::quiet_NaN()' },
      ...
      { sourceMember: 'isSafeInteger', targetName: 'flight::is_safe_integer' },
      { sourceMember: 'parseFloat', targetName: 'flight::parse_float' },
      { sourceMember: 'parseInt', targetName: 'flight::parse_int' },
    ],
    sourceName: 'Number',
    space: 'value',
  ...
  {
    capability: 'error',
    headers: ['flight/error.hpp'],
    kind: 'runtime',
    sourceName: 'RangeError',
    space: 'type',
    targetName: 'flight::RangeError',
  },
  {
    capability: 'error',
    headers: ['flight/error.hpp'],
  ...
  {
    capability: 'record',
    headers: ['flight/record.hpp'],
    kind: 'runtime',
    sourceName: 'Record',
    space: 'type',
    targetName: 'flight::Record',
  },
