...
const cppFlightRuntimeAmbientMemberBindings: Readonly<Record<string, CompilerCppAmbientMemberBinding>> = {
  ...
  'dataView.byteLength': { kind: 'sizeProperty', targetName: 'byte_length' },
  'dataView.byteOffset': { kind: 'sizeProperty', targetName: 'byte_offset' },
  ...
  'typedArray.byteLength': { kind: 'sizeProperty', targetName: 'byte_length' },
  'typedArray.byteOffset': { kind: 'sizeProperty', targetName: 'byte_offset' },
