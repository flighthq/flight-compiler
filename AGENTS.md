...
Coverage thresholds are enforced ratchets, not aspirational targets: the current 94.7% branches, 98.8% functions, 97.4% lines, and 96.5% statements floors sit immediately below the combined compiler baseline (94.76 / 98.82 / 97.47 / 96.55 on 2026-09-10) so regressions fail promptly. Maintain or raise them as exercised compiler surface grows. Lowering a threshold requires an explicit architectural justification.
