...
Coverage thresholds are enforced ratchets, not aspirational targets: the current 95.5% branches, 99% functions, 97.75% lines, and 96.75% statements floors sit immediately below the measured baseline (95.55 / 99.06 / 97.91 / 96.99 on 2026-09-09) so regressions fail promptly. Maintain or raise them as exercised compiler surface grows. Lowering a threshold requires an explicit architectural justification.
