...
Coverage thresholds are enforced ratchets, not aspirational targets: the current 95.5% branches, 99% functions, 97.9% lines, and 97% statements floors sit immediately below the measured baseline (95.56 / 99.09 / 97.92 / 97.00 on 2026-09-09) so regressions fail promptly. Maintain or raise them as exercised compiler surface grows. Lowering a threshold requires an explicit architectural justification.
