...
Coverage thresholds are enforced ratchets, not aspirational targets: the current 94.8% branches, 98.8% functions, 97.5% lines, and 96.5% statements floors sit immediately below the combined compiler baseline (94.88 / 98.82 / 97.51 / 96.58 on 2026-09-09) so regressions fail promptly. Maintain or raise them as exercised compiler surface grows. Lowering a threshold requires an explicit architectural justification.
