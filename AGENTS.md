...
Coverage thresholds are enforced ratchets, not aspirational targets: the current 94.7% branches, 98.7% functions, 97.3% lines, and 96.4% statements floors sit immediately below the combined compiler baseline (94.72 / 98.72 / 97.39 / 96.48 on 2026-09-09) so regressions fail promptly. Maintain or raise them as exercised compiler surface grows. Lowering a threshold requires an explicit architectural justification.
